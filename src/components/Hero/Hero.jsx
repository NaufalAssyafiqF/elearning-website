...
const Hero = () => {
  return (
    <>
      <div className="container grid grid-cols-1 md:grid-cols-2 mih-h-[650px] relative">
        {/* brand info */}
          ...
          <div className="text-center md:text-left space-y-6">
            ...
            >
              ...
              <button className="flex justify-end items-center gap-2 font-semibold">
                <span className="w-10 h-10 bg-secondary/15 rounded-full flex items-center justify-center">
